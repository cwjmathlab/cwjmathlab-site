...
export const finalStages = [
  { stage: 1 as const, roman: 'I', title: '1단계 · 수능 전 파이널', headline: '수능 전 실전 감각 완성', range: '08.02 → 10.04', count: '5개 과정', goal: '수능 전, 각 학교 실제 응시환경을 그대로 재현하여 실전 감각과 시간 관리 능력을 완성한다.' },
  ...
  { stage: 3 as const, roman: 'III', title: '3단계 · 논술주간 · 최종 파이널', headline: '최종 마감 프로그램', range: '11.23 → 12.05', count: '5개 과정 · 최종 마감', goal: '수능 이후, 실전 그 자체. 지원 대학에 대한 자신의 증명을 완결한다.' },
];
...
export const finalPrograms: FinalProgram[] = [
  ...
  {
    no: 4, stage: 1, name: '성균관대', kind: 'Pre-Final · 총 4회', day: '일요일 오후', time: '13:00 — 16:00 (180분)', period: '08.02 → 08.23',
    sessions: [{ date: '08.02 일' }, { date: '08.09 일' }, { date: '08.16 일' }, { date: '08.23 일' }],
    note: '실전 파이널 11.20(금) 12시 · 2단계', examDate: '11.22(일)', done: true,
  },
  {
    no: 5, stage: 1, name: '중앙대', sub: '창의형', kind: 'Final · 총 5회', day: '일요일 오후', time: '13:00 — 16:00 (180분)', period: '09.06 → 10.04',
    sessions: [{ date: '09.06 일' }, { date: '09.13 일' }, { date: '09.20 일' }, { date: '09.27 일' }, { date: '10.04 일' }],
    examDate: '10.11(일)',
  },
  // ───────── II. 수능 후 시험 대학 · 직전 FINAL ─────────
  {
    no: 6, stage: 2, name: '숭실 · 항공대', sub: '공학', kind: '파이널 · 5회 + 실전', day: '토요일 오전', time: '09:00 — 12:00 (180분)', period: '10.17 → 11.14',
    sessions: [{ date: '10.17 토' }, { date: '10.24 토' }, { date: '10.31 토' }, { date: '11.07 토' }, { date: '11.14 토' }],
    live: { date: '11.20 금', time: '오전 9시' }, examDate: '11.21(토)',
  },
  {
    no: 7, stage: 2, name: '고려 · 서강대', kind: '파이널 · 5회 + 실전', day: '일요일 저녁', time: '19:00 — 22:00 (180분)', period: '10.11 → 11.08',
    sessions: [{ date: '10.11 일' }, { date: '10.18 일' }, { date: '10.25 일' }, { date: '11.01 일' }, { date: '11.08 일' }],
    live: { date: '11.20 금', time: '저녁 19시' }, examDate: '11.21(토)',
  },
  {
    no: 8, stage: 2, name: '경희 · 동국대', kind: '파이널 · 5회 + 실전', day: '일요일 오후', time: '16:00 — 19:00 (180분)', period: '10.11 → 11.08',
    sessions: [{ date: '10.11 일' }, { date: '10.18 일' }, { date: '10.25 일' }, { date: '11.01 일' }, { date: '11.08 일' }],
  ...
  // ───────── III. 논술주간 · 최종 파이널 ─────────
  { no: 10, stage: 3, name: '세종대', kind: '파이널', day: '5일간 실전', time: '오후 15:00 — 18:00', period: '11.23 → 11.27', examDate: '11.28(토) 자유전공 · 11.29(일) 자연' },
  { no: 11, stage: 3, name: '중앙대', sub: '일반', kind: '파이널', day: '5일간 실전', time: '오전 09:00 — 12:00', period: '11.23 → 11.27', examDate: '11.28(토)' },
  { no: 12, stage: 3, name: '한양대', kind: '파이널', day: '5일간 실전', time: '낮 12:00 — 15:00', period: '11.23 → 11.27', examDate: '11.29(일)' },
  { no: 13, stage: 3, name: '인하대', sub: '프리', kind: '프리 파이널', day: '5일간 실전 · 라스트로 연계', time: '저녁 19:00 — 22:00', period: '11.23 → 11.27', examDate: '12.06(일)' },
  { no: 14, stage: 3, name: '인하대', sub: '라스트', kind: '★ 라스트 파이널', day: '총 6회 · 수능 후 최종 마감', time: '오후 16:00 — 19:00', period: '11.30 → 12.05', examDate: '12.06(일)', highlight: true },
];
